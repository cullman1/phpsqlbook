 ...
 */
          var body = '<ul class="nav nav-tabs">' + 
                       ...
                       '<li><a href="#upload-library" data-toggle="tab">Library</a></li>' + 
                      '</ul>' +
                      '<div class="tab-content">' + 
                        '<div class="tab-pane active" id="upload-tab"><iframe width="500" height="200" style="border:none;" src="/includes/upload.php"></iframe><button href="#" class="btn btn-primary note-image-btn">' + lang.image.insert + '</button></div>' +
                        '<div class="tab-pane" id="upload-library"><iframe width="500" height="200" style="border:none;" src="/includes/gallerymodal2.php"></div>' +
                      '</div>';
        var footer = '';
