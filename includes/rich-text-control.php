  <div class="btn-toolbar" data-role="editor-toolbar" data-target="#rich-text-container">
   ...
   alert("Type OR cut and paste in a full link along with the http:// bit here:");
      ...
      <div class="btn-group">
      <a class="btn dropdown-toggle" data-toggle="dropdown" title="Hyperlink"><i class="fa fa-chain"></i></a>
        <div class="dropdown-menu input-append">
          <input class="span2" placeholder="URL" type="text" data-edit="createLink" onmousedown="myFunction2()"/>
      ...
      <div class="btn-group">
        ...
        <a class="btn" data-edit="redo" title="Redo (Ctrl/Cmd+Y)"><i class="fa fa-repeat"></i></a>
      	 ...
      	 <div class="btn-group">
 					<a class="btn"	data-edit="html"><i class="fa fa-file"></i></a>
 				</div>
 		</div>
    </div>
