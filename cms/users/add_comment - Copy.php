...
echo "REPLY ". $reply_to . " AND". $toplevelparentid;
...
if (!empty($comment)) {
 ...
 $comment = new Comment(0, $article_id, $user->id, $user->forename, $user->surname, $user->image, $comment , date("Y-m-d H:i:s"),  $reply_to, $toplevelparentid);
 if ($comment->add()) {
