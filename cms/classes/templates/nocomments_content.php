...
<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#collapsed{{article.article_id}}">
 <img src="/cms/assets/comments-xl.png" /> Comments: 0 - Be the first to comment! </a>
