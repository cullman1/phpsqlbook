<div id="accordion3">
    <div class="accordion-group">
         <form id="likeform" method="post" action="../../code/includes/submit-like.php?user_id=<?php echo $_REQUEST["user_id"]; ?>&article_id=<?php echo $_REQUEST["article_id"]; ?>">
            <div> 
...
<script type="text/javascript">
    function submitLike() {
        ...
        $.ajax({
            url: '../../code/includes/submit-like.php?user_id=<?php echo $_REQUEST["user_id"]; ?>&article_id=<?php echo $_REQUEST["article_id"]; ?>&liked=' + $('#like_button').attr('value'),  //Server script to process data
         type: 'POST',
