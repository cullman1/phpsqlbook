...
class Gallery {
 ...
 function __construct($id, $name = NULL, $mode = NULL, $items = NULL, $firstImage = NULL) {
 ...
 function get_gallery_list() { 
  ...
  $statement->setFetchMode(PDO::FETCH_CLASS, 'Gallery');   // Step 4 Set fetch mode to array
  $gallery_list = $statement->fetch();     // Step 4 Get all rows ready to display
  return $gallery_list;
}
echo "1";
