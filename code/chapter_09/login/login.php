...
function get_user($connection, $email, $password) {
  $query = "SELECT COUNT(*) as exist, user.id, forename, surname, email, access_level FROM user Join role on role_id = role.id WHERE email =:email AND password= :password";
