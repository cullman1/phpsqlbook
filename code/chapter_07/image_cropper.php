...
<div id="body">
    <form id="galleryform" method="post" action="image_cropper.php" onsubmit="assigncontent()" enctype="multipart/form-data">
      <div id="middlewide">
        <div id="leftcol">
          ...
          <div id="Status_Post">
               ...
               function crop_image($filename, $width_resize, $height_resize) {
