...
$select_category_sql = "select id, name FROM 387732_phpbook1.category";
...
if (isset($_REQUEST['Submitted']))
{
    ...
    $insert_article_sql = "INSERT INTO article (title, content, date_posted, category_id, parent_id, user_id) VALUES ('".$_REQUEST['ArticleTitle']."', '".$_REQUEST['ArticleContent']."',  '". date("Y-m-d H:i:s") ."', '".$_REQUEST['CategoryId']."', '".$_REQUEST['PageId']."', '".$user_object->getAuthenticated()."')";
            ...
            <tr>
              ...
              <td>
                  <select id="CategoryId" name="CategoryId">
                     ...
                     <option value="<?php  echo $select_category_row['id']; ?>"><?php  echo $select_category_row['name']; ?></option>
                     <?php } ?> 
                  </select>
              </td>
            </tr>
