...
<table class="table_syntax">
  ...
  <tr>
    ...
    <td>Position of first occurrence of a substring (case sensitive)</td>
  </tr>

  <tr>
    <td class="result"><?php echo strpos($string, 'me', 5) ?></td>
    <td><code class="php">strpos($string, 'me', 5);</code></td>
    <td>Position of first occurrence of a string after a specified character position</td>
  </tr>
  ...
  <tr>
    ...
    <td>Position of last occurrence of a string</td>
  </tr>
  ...
  <tr>
    ...
    <td>Position of first character in last occurrence of a substring</td>
  </tr>
