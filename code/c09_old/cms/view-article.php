...
<section>
  ...
  <div class="credit">
   <?= htmlentities($article->category, ENT_QUOTES, 'UTF-8') ?>  by <a href="<?= ROOT ?>view-user.php?id=
    <?= $article->user_id ?>"><?= htmlentities($article->author, ENT_QUOTES, 'UTF-8') ?></a> on <?= $article->created ?>
  </div>
  <div class="row">
