...
class Controller {
  ...
  public function __construct($controller,$category, $item) { 
 ...
 public function createPageStructure() { 
  $this->registry->set('LayoutTemplate',  new LayoutTemplate($this->controller,  $this->category, $this->item, $this->pdo ));  
