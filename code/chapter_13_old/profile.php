...
if(isset($_FILES['uploader'])) {
    ...
    $folder = dirname(__FILE__) ."/uploads/". $userimage;
            ...
            <tr><td></td><td>&nbsp; </td></tr>
               <tr>
				 <td style="vertical-align:top;"><span class="fieldheading" >User Image:</span></td>
                   	 <td><img src="../../uploads/<?php echo $select_user_row['user.user_image']; ?>" /><br /><br /><input id="UserImage"  name="UserImage" type="text" value="<?php echo $select_user_row['user.user_image']; ?>" /><br /><br /><input type="file" id="uploader" name="uploader" /></td> 
